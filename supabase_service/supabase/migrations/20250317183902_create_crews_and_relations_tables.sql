...
CREATE TYPE agent_role_type AS ENUM ('manager', 'worker');
...
create table "public"."Crews" (
    ...
    "manager_llm_id" bigint references "public"."LLMs"(id),
    "function_calling_llm_id" bigint references "public"."LLMs"(id),
    "config" jsonb,
    "max_rpm" integer,
    ...
    "planning_llm_id" bigint references "public"."LLMs"(id),
...
create table "public"."crew_agents" (
    ...
    "role" agent_role_type default 'worker',
