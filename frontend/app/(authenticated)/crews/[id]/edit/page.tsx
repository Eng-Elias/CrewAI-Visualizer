...
const mockCrew: z.infer<typeof formSchema> = {
  id: 1,
...
export default function EditCrewPage({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: mockCrew,
  });

  useEffect(() => {
    // TODO: Fetch crew data and update form
    form.reset(mockCrew);
  }, [form]);
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    router.push(`/crews/${resolvedParams.id}`);
  }
    ...
    <div className="p-6">
      <div className="flex items-center gap-4 mb-6">
        <Button
          variant="ghost"
          size="icon"
          onClick={() => router.push(`/crews/${resolvedParams.id}`)}
        >
          <ArrowLeft className="h-4 w-4" />
        </Button>
        <h1 className="text-2xl font-bold">Edit Crew</h1>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Update your crew&apos;s settings and behavior
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
